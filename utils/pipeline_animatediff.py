...
class AnimateDiffPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __init__(
        ...
        self.unet = UNetMotionModel.from_unet2d(self.unet, self.motion_adapter)
    ...
    def _encode_prompt(
        ...
        prompt_embeddings = torch.cat([negative_prompt_embeds, prompt_embeds], dim=0)
    ...
    def __call__(
        ...
        if isinstance(prompt_embeds, list):
            prompt_embeds = prompt_embeds
            negative_prompt_embeds = negative_prompt_embeds
            prompt_embeds = [torch.cat([negative_prompt_embeds[num], prompt_embeds[num]]) for num in range(16)]
        else:
            prompt_embeds = prompt_embeds
            negative_prompt_embeds = negative_prompt_embeds
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.unet(
                    ...
                    t,
                    encoder_hidden_states=prompt_embeds,  # 2 539 768
